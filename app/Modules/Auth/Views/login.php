...
<div class="container">
    <div class="row justify-content-center pt-5">
        <div class="col-7 shadow rounded" style="background-color: #CCF2F4; height:450px; padding:20px">
            ...
            <?php endif; ?>
            <form class="formAuth" method="POST" action="<?= base_url('/auth/login/cek') ?>">
                <?= csrf_field() ?>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Email</label>
                    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="email@gmail.com" name="email" required>
                </div>
                <div class="mb-3">
